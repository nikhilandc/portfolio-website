...
const HeroEditor: React.FC = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-bold text-white mb-6">Edit Hero Section</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label htmlFor="subtitle" className="block text-white mb-2">
            Subtitle
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="backgroundImage" className="block text-white mb-2">
